...
All the data you need for this course is provided in this course. You do not need to look elsewhere, i.e. Obvience, for it. You are allowed to use the data in the context of this course, but not elsewhere.# DAT206x--Advanced-Data-Analysis-and-Visualisation-Using-Microsoft-Excel
